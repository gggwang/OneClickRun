var rule = {
	...
	class_url:'1&2&3&4',
	play_parse:true,
    lazy:'js:if(/Feiyun/.test(input)){let purl=request("http://htp.behds.cn/json/2023123456/fy4k2.php?url="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}else{input}', 
    limit:6,
	推荐:'*',
